...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-f5c5ea56.js", "src/routes/index.svelte": "pages\\index.svelte-63d514f0.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-aab6d365.css", "assets/pages\\index.svelte-1f52df77.css"],
      js: ["start-f5c5ea56.js", "chunks/vendor-57a96aae.js", "pages\\index.svelte-63d514f0.js"]
    }
  ]
};
...
var Counter_svelte_svelte_type_style_lang = "button.svelte-1k09mxd{font-family:inherit;font-size:inherit;padding:1em 2em;color:#ff3e00;background-color:rgba(255, 62, 0, 0.1);border-radius:2em;border:2px solid #ff3e00;outline:none;width:200px;height:60px;font-variant-numeric:tabular-nums}button.svelte-1k09mxd:hover{border:3px solid #ff3e00}button.svelte-1k09mxd:active{background-color:rgba(255, 62, 0, 0.2)}";
const css$1 = {
  code: "button.svelte-1k09mxd{font-family:inherit;font-size:inherit;padding:1em 2em;color:#ff3e00;background-color:rgba(255, 62, 0, 0.1);border-radius:2em;border:2px solid #ff3e00;outline:none;width:200px;height:60px;font-variant-numeric:tabular-nums}button.svelte-1k09mxd:hover{border:3px solid #ff3e00}button.svelte-1k09mxd:active{background-color:rgba(255, 62, 0, 0.2)}",
  map: '{"version":3,"file":"Counter.svelte","sources":["Counter.svelte"],"sourcesContent":["<script lang=\\"ts\\">let count = 0;\\r\\nconst increment = () => {\\r\\n    count += 1;\\r\\n};\\r\\n</script>\\n\\n<button on:click={increment}>\\n\\tClicks: {count}\\n</button>\\n\\n<style lang=\\"scss\\">button {\\n  font-family: inherit;\\n  font-size: inherit;\\n  padding: 1em 2em;\\n  color: #ff3e00;\\n  background-color: rgba(255, 62, 0, 0.1);\\n  border-radius: 2em;\\n  border: 2px solid #ff3e00;\\n  outline: none;\\n  width: 200px;\\n  height: 60px;\\n  font-variant-numeric: tabular-nums;\\n}\\n\\nbutton:hover {\\n  border: 3px solid #ff3e00;\\n}\\n\\nbutton:active {\\n  background-color: rgba(255, 62, 0, 0.2);\\n}</style>\\n"],"names":[],"mappings":"AAUmB,MAAM,eAAC,CAAC,AACzB,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,GAAG,CAAC,GAAG,CAChB,KAAK,CAAE,OAAO,CACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACvC,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CACZ,oBAAoB,CAAE,YAAY,AACpC,CAAC,AAED,qBAAM,MAAM,AAAC,CAAC,AACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAC3B,CAAC,AAED,qBAAM,OAAO,AAAC,CAAC,AACb,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACzC,CAAC"}'
};
const Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let count = 0;
  $$result.css.add(css$1);
  return `<button class="${"svelte-1k09mxd"}">Clicks: ${escape(count)}
</button>`;
});
var index_svelte_svelte_type_style_lang = "main.svelte-1i4qx1{text-align:center;padding:1em;margin:0 auto}h1.svelte-1i4qx1{color:#ff3e00;text-transform:uppercase;font-size:4rem;font-weight:100;line-height:1.1;margin:4rem auto;max-width:14rem}p.svelte-1i4qx1{max-width:14rem;margin:2rem auto;line-height:1.35}@media(min-width: 480px){h1.svelte-1i4qx1{max-width:none}p.svelte-1i4qx1{max-width:none}}";
const css = {
  code: "main.svelte-1i4qx1{text-align:center;padding:1em;margin:0 auto}h1.svelte-1i4qx1{color:#ff3e00;text-transform:uppercase;font-size:4rem;font-weight:100;line-height:1.1;margin:4rem auto;max-width:14rem}p.svelte-1i4qx1{max-width:14rem;margin:2rem auto;line-height:1.35}@media(min-width: 480px){h1.svelte-1i4qx1{max-width:none}p.svelte-1i4qx1{max-width:none}}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script lang=\\"ts\\">import Counter from '$lib/Counter.svelte';\\r\\n</script>\\n\\n<main>\\n\\t<h1>Hello world!</h1>\\n\\n\\t<Counter />\\n\\n\\t<p>Visit <a href=\\"https://svelte.dev\\">svelte.dev</a> to learn how to build Svelte apps.</p>\\n</main>\\n\\n<style lang=\\"scss\\">main {\\n  text-align: center;\\n  padding: 1em;\\n  margin: 0 auto;\\n}\\n\\nh1 {\\n  color: #ff3e00;\\n  text-transform: uppercase;\\n  font-size: 4rem;\\n  font-weight: 100;\\n  line-height: 1.1;\\n  margin: 4rem auto;\\n  max-width: 14rem;\\n}\\n\\np {\\n  max-width: 14rem;\\n  margin: 2rem auto;\\n  line-height: 1.35;\\n}\\n\\n@media (min-width: 480px) {\\n  h1 {\\n    max-width: none;\\n  }\\n\\n  p {\\n    max-width: none;\\n  }\\n}</style>\\n"],"names":[],"mappings":"AAWmB,IAAI,cAAC,CAAC,AACvB,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,SAAS,CACzB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,CAAC,cAAC,CAAC,AACD,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,CAAC,cAAC,CAAC,AACD,SAAS,CAAE,IAAI,AACjB,CAAC,AACH,CAAC"}`
};
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-1i4qx1"}"><h1 class="${"svelte-1i4qx1"}">Hello world!</h1>

	${validate_component(Counter, "Counter").$$render($$result, {}, {}, {})}

	<p class="${"svelte-1i4qx1"}">Visit <a href="${"https://svelte.dev"}">svelte.dev</a> to learn how to build Svelte apps.</p>
</main>`;
});
